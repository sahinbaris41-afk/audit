...
class EnhancedLegalAnalyzer:
    ...
    def generate_txt_report(self):
        with open(self.output_file, 'w', encoding='utf-8') as f:
            f.write("="*70 + "\n")
            f.write("GABRELA YAPAZ ZEKA DENETİM SİSTEMİ\n")
            f.write("="*70 + "\n\n")
...
""")
            if self.logo_path and self.report_options["Genel Bilgiler"].get():
                try:
                    ...
                    pass
            f.write("""
        <h1>GABRELA YAPAY ZEKA DENETİM SİSTEMİ</h1>
    </div>
""")
            if self.report_options["Genel Bilgiler"].get():
                f.write("""
...
""")
    ...
    def generate_pdf_report(self):
        ...
        pdf.cell(200, 10, txt="GABRELA YAPAY ZEKA DENETİM SİSTEMİ", ln=True, align='C')
        if self.report_options["Genel Bilgiler"].get():
